...
1) Create your own Google Sheets mailing list by following the tutorial by David McCoy: https://medium.com/@murateksioglu
...
* **Matthew Waldron** - (http://murateksioglu.com)
